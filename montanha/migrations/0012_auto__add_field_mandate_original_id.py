...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mandate.original_id'
        db.add_column(u'montanha_mandate', 'original_id',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mandate.original_id'
        db.delete_column(u'montanha_mandate', 'original_id')
