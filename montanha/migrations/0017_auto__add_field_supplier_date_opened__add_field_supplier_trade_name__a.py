...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'montanha_supplier', 'date_opened')

        # Deleting field 'Supplier.trade_name'
        db.delete_column(u'montanha_supplier', 'trade_name')

        # Deleting field 'Supplier.address'
        db.delete_column(u'montanha_supplier', 'address')

        # Deleting field 'Supplier.juridical_nature'
        db.delete_column(u'montanha_supplier', 'juridical_nature')

        # Deleting field 'Supplier.status'
        db.delete_column(u'montanha_supplier', 'status')

        # Deleting field 'Supplier.main_economic_activity'
        db.delete_column(u'montanha_supplier', 'main_economic_activity')
    ...
    models = {
        ...
        u'montanha.politicalparty': {
            ...
            'siglum': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '15'}),
        ...
        u'montanha.supplier': {
            ...
            'juridical_nature': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'last_change': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'main_economic_activity': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'status': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'trade_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        }
    }
