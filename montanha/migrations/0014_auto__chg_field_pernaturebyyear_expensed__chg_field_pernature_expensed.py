...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PerNatureByYear.expensed'
        db.alter_column(u'montanha_pernaturebyyear', 'expensed', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

        # Changing field 'PerNature.expensed'
        db.alter_column(u'montanha_pernature', 'expensed', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

        # Changing field 'PerLegislator.expensed'
        db.alter_column(u'montanha_perlegislator', 'expensed', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

        # Changing field 'PerNatureByMonth.expensed'
        db.alter_column(u'montanha_pernaturebymonth', 'expensed', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

        # Changing field 'BiggestSupplierForYear.expensed'
        db.alter_column(u'montanha_biggestsupplierforyear', 'expensed', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'PerNatureByYear.expensed'
        db.alter_column(u'montanha_pernaturebyyear', 'expensed', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'PerNature.expensed'
        db.alter_column(u'montanha_pernature', 'expensed', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'PerLegislator.expensed'
        db.alter_column(u'montanha_perlegislator', 'expensed', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'PerNatureByMonth.expensed'
        db.alter_column(u'montanha_pernaturebymonth', 'expensed', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

        # Changing field 'BiggestSupplierForYear.expensed'
        db.alter_column(u'montanha_biggestsupplierforyear', 'expensed', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
    ...
    models = {
        ...
        u'montanha.biggestsupplierforyear': {
            ...
            'expensed': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'supplier': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['montanha.Supplier']"}),
        ...
        u'montanha.legislator': {
            ...
            'alternative_names': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['montanha.AlternativeLegislatorName']", 'symmetrical': 'False'}),
        ...
        u'montanha.mandate': {
            ...
            'legislature': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['montanha.Legislature']"}),
            'original_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'party': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['montanha.PoliticalParty']", 'null': 'True', 'blank': 'True'}),
            'state': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'})
        },
