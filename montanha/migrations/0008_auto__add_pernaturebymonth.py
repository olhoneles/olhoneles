...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerNatureByMonth'
        db.create_table(u'montanha_pernaturebymonth', (
        ...
        db.send_create_signal(u'montanha', ['PerNatureByMonth'])


    def backwards(self, orm):
        # Deleting model 'PerNatureByMonth'
        db.delete_table(u'montanha_pernaturebymonth')
