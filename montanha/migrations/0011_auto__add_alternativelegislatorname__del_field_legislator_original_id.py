...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlternativeLegislatorName'
        db.create_table(u'montanha_alternativelegislatorname', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=2048)),
        ))
        db.send_create_signal(u'montanha', ['AlternativeLegislatorName'])

        # Deleting field 'Legislator.original_id'
        db.delete_column(u'montanha_legislator', 'original_id')

        # Adding M2M table for field alternative_names on 'Legislator'
        m2m_table_name = db.shorten_name(u'montanha_legislator_alternative_names')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('legislator', models.ForeignKey(orm[u'montanha.legislator'], null=False)),
            ('alternativelegislatorname', models.ForeignKey(orm[u'montanha.alternativelegislatorname'], null=False))
        ))
        db.create_unique(m2m_table_name, ['legislator_id', 'alternativelegislatorname_id'])


    def backwards(self, orm):
        # Deleting model 'AlternativeLegislatorName'
        db.delete_table(u'montanha_alternativelegislatorname')


        # User chose to not deal with backwards NULL issues for 'Legislator.original_id'
        raise RuntimeError("Cannot reverse this migration. 'Legislator.original_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Legislator.original_id'
        db.add_column(u'montanha_legislator', 'original_id',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)

        # Removing M2M table for field alternative_names on 'Legislator'
        db.delete_table(db.shorten_name(u'montanha_legislator_alternative_names'))
